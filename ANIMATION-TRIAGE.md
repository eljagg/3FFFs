...
| **SIM Card Swap (T1451)** | Initial Access (TA0001) | v25.7.0.14 [MultiActorSequenceAnimation extended to 5 actors with new Insider lane] | Grounded in J$61M Jamaica conviction (Corporate Area Parish Court, October 2025) where two of three convicted were telco customer service representatives. Ms. Tanya Ricketts (Scotia JM customer, Portmore, age 34, marketing coordinator) compromised entirely via insider CSR at Digicel — strong password did not protect her. 8 stages from insider recruitment through cascade across 4 separate accounts (Scotia, Gmail, Apple ID, Sagicor pension). The animation surfaces the structural architecture failure: SMS-2FA is a single point of failure spanning the customer\'s entire digital identity, and no single institution (bank or telco) can defend SIM swap alone. Naive control surfaces "stronger passwords" framing as the failed institutional posture it is — passwords don\'t protect a number that ports. |
...
| ✅ | v25.7.0.14 | SIM Card Swap (T1451) — Initial Access (TA0001) | J$61M conviction October 2025 — multi-actor including insider at telco/bank (2 of 3 convicted were customer service reps); 5-actor sequence with Insider lane |
