...
export const IVR_DISCOVERY_STAGES = [
  ...
  /* ─── Stage 3 ────────────────────────────────────────────────────── */
  {
    ...
    audio: { text: 'Enter your eight-digit account number. Account number not recognized. Please try again.', profile: 'system' },
    durationMs: 5500,
    focalZone: 'ivr',
    attackerZone: {
      notepad: [
  ...
  /* ─── Stage 4 ────────────────────────────────────────────────────── */
  {
    ...
    audio: { text: 'Enter your account number. Thank you. Now enter your four-digit PIN.', profile: 'system' },
    durationMs: 5500,
    focalZone: 'attacker',
    attackerZone: {
      notepad: [
  ...
  /* ─── Stage 5 ────────────────────────────────────────────────────── */
  {
    ...
    audio: { text: 'Authentication successful. Your balance is fourteen thousand two hundred dollars.', profile: 'system' },
    durationMs: 6000,
    focalZone: 'ivr',
    attackerZone: {
      notepad: [
