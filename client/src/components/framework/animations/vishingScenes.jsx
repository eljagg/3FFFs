  ...
  /* Stage 2 — The call comes in */
  {
    ...
    messages: [
      ...
      { id: 'vh-m2-2', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"Officer Reid, FID. Activity on your JNCB account."',
        audio: { text: 'Mister Henry? This is Officer Marlon Reid from the Financial Investigations Division. I am calling about activity on your JNCB business account that I need to discuss with you urgently.', profile: 'authority' } },
    ],
  ...
  /* Stage 3 — Authority + urgency + isolation */
  {
    ...
    messages: [
      { id: 'vh-m3-1', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"You can verify with FID — but bank may be compromised."', tooltip: 'Isolation script — designed to defeat callback', suspicious: true,
        audio: { text: 'You can hang up and call FID directly to confirm I am a real officer. However, our investigation is at a sensitive stage. We have reason to believe a JNCB employee may be involved in the fraud ring we are tracking.', profile: 'authority' } },
      { id: 'vh-m3-2', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"15 minutes of your discretion to catch the suspect."',
        audio: { text: 'I need fifteen minutes of your discretion to catch the suspect. If you call JNCB directly, you may tip them off and we lose the case.', profile: 'authority' } },
    ],
  ...
  /* Stage 4 — The pretext */
  {
    ...
    messages: [
      { id: 'vh-m4-1', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"J$5.8M will be fraudulently transferred — we\'ll protect it."', suspicious: true,
        audio: { text: 'Mister Henry, five point eight million Jamaican dollars is about to be fraudulently transferred out of your account. We have been monitoring this for forty-eight hours. To protect your funds during the investigation, FID will move the five point eight million to a protected holding account in your name.', profile: 'authority' } },
      { id: 'vh-m4-2', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"Holding account in your name · 48-hour return"',
        audio: { text: 'The funds will be returned within forty-eight hours after we close the case.', profile: 'authority' } },
    ],
    revealedSignalIds: ['sig-isolation-script'],
  },
  ...
  /* Stage 5 — The transfer instruction */
  {
    ...
    messages: [
      { id: 'vh-m5-1', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"Log into JNCB. Stay on the call."',
        audio: { text: 'I need you to log into JNCB online banking on your phone. Stay on the call. Do not put me on speaker — your phone microphone needs to stay clean for the recording.', profile: 'authority' } },
      ...
      { id: 'vh-m5-3', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"Beneficiary: JNCB Asset Protection Trust · 8841-7720-3349"', suspicious: true,
        audio: { text: 'Beneficiary name: JNCB Asset Protection Trust. Account number: eight eight four one, seven seven two zero, three three four nine. Amount: five million eight hundred thousand Jamaican dollars.', profile: 'authority' } },
  ...
  /* Stage 6 — OTP capture */
  {
    ...
    messages: [
      { id: 'vh-m6-1', fromActor: 'jncb', toActor: 'devon', kind: 'sms', label: 'OTP: 738291 · "NEVER share this code"',
        audio: { text: 'JNCB. Seven three eight two nine one is your one-time code. Never share this code with anyone, including JNCB staff.', profile: 'system' } },
      { id: 'vh-m6-2', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"That warning is for external scams. Read me the six digits."', suspicious: true,
        audio: { text: 'Yes, I see — that warning is for protection against external scams. Since I am FID, not JNCB staff, the warning does not apply. Read me the six digits.', profile: 'authority' } },
  ...
  /* Stage 7 — Callback control bypass */
  {
    ...
    messages: [
      { id: 'vh-m7-1', fromActor: 'jncb', toActor: 'devon', kind: 'callback', label: 'Automated callback · "Did you authorize J$5.8M transfer?"',
        audio: { text: 'Mister Henry, this is JNCB security calling about a transfer. Did you authorize a transfer of five point eight million dollars to JNCB Asset Protection Trust?', profile: 'investigator' } },
      { id: 'vh-m7-2', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"Tell them YES — that confirms your identity."', suspicious: true,
        audio: { text: 'JNCB security is calling you to verify. Tell them YES, you authorized the protective transfer. That is how the system confirms it is really you.', profile: 'authority' } },
  ...
  /* Stage 8 — Realization */
  {
    ...
    messages: [
      { id: 'vh-m8-1', fromActor: 'fraudster', toActor: 'devon', kind: 'callback', label: '"Don\'t contact JNCB · 48-hour return · confirmation tonight"',
        audio: { text: 'Mister Henry, the protective transfer is complete. Your funds are secure. FID will return them within forty-eight hours after the case is closed. You will receive a confirmation email from FID this evening. Do not contact JNCB about this — it would compromise the investigation. Have a good day.', profile: 'authority' } },
      { id: 'vh-m8-2', fromActor: 'devon', toActor: 'jncb', kind: 'callback', label: '"Where is my J$5.8M? It\'s been 3 days."', tooltip: 'Day +3 · funds dispersed',
        audio: { text: 'Where is my five point eight million? It has been three days.', profile: 'victimMale' } },
      { id: 'vh-m8-3', fromActor: 'jncb', toActor: 'devon', kind: 'callback', label: '"Your callback authorization cleared the transfer."',
        audio: { text: 'Your callback authorization cleared the transfer. The funds were dispersed within minutes.', profile: 'investigator' } },
    ],
